...
## Table of Contents
 ...
 - [Instructions to download project Github ](https://github.com/Global-Manu-Man/emmanuel-cv-app.git)
...
- For example, if your HTML project is located at C:\xampp\htdocs\emmanuel-cv-app, you can access it in your browser by typing http://localhost
...
```bash
  ...
  git clone https://github.com/Global-Manu-Man/emmanuel-cv-app.git
...
http://localhost/emmanuel-cv-app/


![Logo](https://locallity-logos.s3.us-west-1.amazonaws.com/Screenshot_13.png)

![Logo](https://locallity-logos.s3.us-west-1.amazonaws.com/Screenshot_12.png)
